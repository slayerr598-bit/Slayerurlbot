...
my_name = "𝕽𝖆𝖏𝖆𝖘𝖙𝖍𝖆𝖓𝖎"
CHANNEL_ID = "-1003166167318"##change it with your channel 🆔 
...
async def start(client: Client, msg: Message):
    ...
    await start_message.edit_text(
        Data.START.format(msg.from_user.mention) +
        "Checking status Ok... 𝕽𝖆𝖏𝖆𝖘𝖙𝖍𝖆𝖓𝖎 **Bot Made BY-𝕽𝖆𝖏𝖆𝖘𝖙𝖍𝖆𝖓𝖎**🔍\n\n"
        "Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
    )
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\nTitle: {name1} @𝕽𝖆𝖏𝖆𝖘𝖙𝖍𝖆𝖓𝖎  {res}.mkv\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖🇮🇳📖✦━━━━━**'
                cc1 = f'**📁 PDF_ID: {str(count).zfill(3)}.\n\nTitle: {name1} @𝕽𝖆𝖏𝖆𝖘𝖙𝖍𝖆𝖓𝖎.pdf\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖🇮🇳📖✦━━━━━**'
